...
CREATE TABLE `audit_categories` (
  ...
  `tipoOperacion` varchar(1) DEFAULT NULL
...
INSERT INTO `auditoria_clientes` VALUES (1,92,'INSERT',NULL,'Nombre: El pepe, Contacto: Juantio, Dirección: Carre4, Ciudad: Bogota, Código Postal: 11111, País: Colombia','2024-08-09 12:01:04'),(2,93,'INSERT',NULL,'Nombre: Juanito, Contacto: El pep, Dirección: Carrera 40, Ciudad:  BoGOTA, Código Postal: 5285, País: Colombia','2024-08-09 12:05:19'),(3,93,'UPDATE','Nombre: Juanito, Contacto: El pep, Dirección: Carrera 40, Ciudad:  BoGOTA, Código Postal: 5285, País: Colombia','Nombre: Miguel, Contacto: El migue, Dirección: jksajdsjak, Ciudad: jaskdjkaskjdsa+, Código Postal: 655465454, País: skkjaskjsa','2024-08-09 12:07:55'),(4,93,'DELETE','Nombre: Miguel, Contacto: El migue, Dirección: jksajdsjak, Ciudad: jaskdjkaskjdsa+, Código Postal: 655465454, País: skkjaskjsa',NULL,'2024-08-09 12:09:01'),(5,94,'INSERT',NULL,'Nombre: Myke , Contacto: wasasky, Dirección: calle, Ciudad: Bogota, Código Postal: 41236, País: Colombia','2024-08-09 12:30:54'),(6,5,'UPDATE','Nombre: Berglunds snabbköp, Contacto: Christina Berglund, Dirección: Berguvsvägen 8, Ciudad: Luleå, Código Postal: S-958 22, País: Sweden','Nombre: Angel, Contacto: DeMaiz , Dirección: carrera, Ciudad: Bogotaa, Código Postal: 369, País: Venezuela','2024-08-09 12:39:35'),(7,94,'DELETE','Nombre: Myke , Contacto: wasasky, Dirección: calle, Ciudad: Bogota, Código Postal: 41236, País: Colombia',NULL,'2024-08-09 12:47:36'),(8,95,'INSERT',NULL,'Nombre: John Doe, Contacto: John Doe, Dirección: 123 Elm Street, Ciudad: Springfield, Código Postal: 12345, País: USA','2024-08-12 09:59:40'),(9,1,'UPDATE','Nombre: Alfreds Futterkiste, Contacto: Maria Anders, Dirección: Obere Str. 57, Ciudad: Berlin, Código Postal: 12209, País: Germany','Nombre: Jane Doe, Contacto: Jane Doe, Dirección: 456 Oak Avenue, Ciudad: Springfield, Código Postal: 67890, País: USA','2024-08-12 09:59:40'),(10,1,'DELETE','Nombre: Jane Doe, Contacto: Jane Doe, Dirección: 456 Oak Avenue, Ciudad: Springfield, Código Postal: 67890, País: USA',NULL,'2024-08-12 09:59:40'),(11,96,'INSERT',NULL,'Nombre: Felix, Contacto: Ale, Dirección: Carrera 40, Ciudad: Bogota, Código Postal: 111111, País: Colombia','2024-08-12 10:09:56'),(12,96,'UPDATE','Nombre: Felix, Contacto: Ale, Dirección: Carrera 40, Ciudad: Bogota, Código Postal: 111111, País: Colombia','Nombre: Juan, Contacto: Cho, Dirección: Carrera 30, Ciudad: Valle, Código Postal: 111111, País: Colombia','2024-08-12 10:11:09'),(13,96,'DELETE','Nombre: Juan, Contacto: Cho, Dirección: Carrera 30, Ciudad: Valle, Código Postal: 111111, País: Colombia',NULL,'2024-08-12 10:11:24'),(14,97,'INSERT',NULL,'Nombre: Juantio, Contacto: Juancho, Dirección: Carrea 50, Ciudad: Bogota, Código Postal: 11111}, País: Colombia','2024-08-12 20:29:22'),(15,97,'UPDATE','Nombre: Juantio, Contacto: Juancho, Dirección: Carrea 50, Ciudad: Bogota, Código Postal: 11111}, País: Colombia','Nombre: Nuen, Contacto: Non, Dirección: Carrea5, Ciudad: Gahahah, Código Postal: 12212, País: Francia','2024-08-12 20:32:46'),(16,97,'DELETE','Nombre: Nuen, Contacto: Non, Dirección: Carrea5, Ciudad: Gahahah, Código Postal: 12212, País: Francia',NULL,'2024-08-12 20:33:08'),(17,98,'INSERT',NULL,'Nombre: Juanito, Contacto: Juan, Dirección: Carrera 69, Ciudad: Bogota, Código Postal: 11111, País: Colobia','2024-08-12 20:39:47'),(18,98,'UPDATE','Nombre: Juanito, Contacto: Juan, Dirección: Carrera 69, Ciudad: Bogota, Código Postal: 11111, País: Colobia','Nombre: Pepito, Contacto: Pepe, Dirección: Carrera 52, Ciudad: Bogota, Código Postal: 52525, País: Venezuela','2024-08-12 20:41:39'),(19,98,'DELETE','Nombre: Pepito, Contacto: Pepe, Dirección: Carrera 52, Ciudad: Bogota, Código Postal: 52525, País: Venezuela',NULL,'2024-08-12 20:42:06');
...
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 DEFINER=`root`@`localhost`*/ /*!50003 TRIGGER Audit_Categories_Insert AFTER insert ON Categories	
  FOR EACH ROW
    INSERT INTO audit_categories (codigo, nombre, descripcion, fecha, usuario, tipoOperacion) 
    values (new.CategoryID, new.CategoryName, new.Description, now(), current_user(), 'I') */;;
DELIMITER ;
...
/*!50003 SET sql_mode              = 'NO_ZERO_IN_DATE,NO_ZERO_DATE,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 DEFINER=`root`@`localhost`*/ /*!50003 TRIGGER Audit_Categories_Update AFTER update ON Categories	
  FOR EACH ROW
    INSERT INTO audit_categories (codigo, nombre, descripcion, fecha, usuario, tipoOperacion) 
    values (old.CategoryID, old.CategoryName, old.Description, now(), current_user(), 'U') */;;
DELIMITER ;
/*!50003 SET sql_mode              = @saved_sql_mode */ ;
/*!50003 SET character_set_client  = @saved_cs_client */ ;
/*!50003 SET character_set_results = @saved_cs_results */ ;
...
/*!50003 SET sql_mode              = 'NO_ZERO_IN_DATE,NO_ZERO_DATE,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 DEFINER=`root`@`localhost`*/ /*!50003 TRIGGER Audit_Categories_Delete BEFORE delete ON Categories	
  FOR EACH ROW
    INSERT INTO audit_categories (codigo, nombre, descripcion, fecha, usuario, tipoOperacion) 
    values (old.CategoryID, old.CategoryName, old.Description, now(), current_user(), 'D') */;;
DELIMITER ;
/*!50003 SET sql_mode              = @saved_sql_mode */ ;
/*!50003 SET character_set_client  = @saved_cs_client */ ;
/*!50003 SET character_set_results = @saved_cs_results */ ;
...
/*!50003 SET sql_mode              = 'NO_ZERO_IN_DATE,NO_ZERO_DATE,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 DEFINER=`root`@`localhost`*/ /*!50003 TRIGGER `despues_insertar_cliente`
...
BEGIN
    ...
    VALUES (
        NEW.`CustomerID`, 
        'INSERT', 
        CONCAT('Nombre: ', NEW.`CustomerName`, ', Contacto: ', NEW.`ContactName`, ', Dirección: ', NEW.`Address`, ', Ciudad: ', NEW.`City`, ', Código Postal: ', NEW.`PostalCode`, ', País: ', NEW.`Country`)
    );
END */;;
DELIMITER ;
/*!50003 SET sql_mode              = @saved_sql_mode */ ;
...
/*!50003 SET sql_mode              = 'NO_ZERO_IN_DATE,NO_ZERO_DATE,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 DEFINER=`root`@`localhost`*/ /*!50003 TRIGGER `despues_actualizar_cliente`
...
BEGIN
    ...
    VALUES (
        OLD.`CustomerID`, 
        'UPDATE', 
        CONCAT('Nombre: ', OLD.`CustomerName`, ', Contacto: ', OLD.`ContactName`, ', Dirección: ', OLD.`Address`, ', Ciudad: ', OLD.`City`, ', Código Postal: ', OLD.`PostalCode`, ', País: ', OLD.`Country`),
        CONCAT('Nombre: ', NEW.`CustomerName`, ', Contacto: ', NEW.`ContactName`, ', Dirección: ', NEW.`Address`, ', Ciudad: ', NEW.`City`, ', Código Postal: ', NEW.`PostalCode`, ', País: ', NEW.`Country`)
    );
END */;;
DELIMITER ;
...
/*!50003 SET sql_mode              = 'NO_ZERO_IN_DATE,NO_ZERO_DATE,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 DEFINER=`root`@`localhost`*/ /*!50003 TRIGGER `despues_eliminar_cliente`
...
BEGIN
    INSERT INTO `customers` (
        ...
        p_CustomerName, p_ContactName, p_Address, p_City, p_PostalCode, p_Country
    );
END ;;
DELIMITER ;
/*!50003 SET sql_mode              = @saved_sql_mode */ ;
...
/*!50003 SET sql_mode              = 'NO_ZERO_IN_DATE,NO_ZERO_DATE,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `ReadCustomer`(
    IN p_CustomerID INT
)
BEGIN
    SELECT 
...
-- Dump completed on 2024-08-12 20:49:06
